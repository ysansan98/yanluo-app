  ...
  >
    ...
    <div class="mt-3 grid grid-cols-[1fr_220px] gap-2">
      ...
      <input
        ...
        placeholder="语言(可选)"
        @input="
          emit('update:language', ($event.target as HTMLInputElement).value)
        "
      >
    </div>
    ...
    <div class="mt-3 grid grid-cols-2 gap-3">
      <div class="rounded-xl border border-yl-line-180 bg-white p-3">
        ...
        <div
          class="mt-1 min-h-16 text-xs leading-5 whitespace-pre-wrap text-yl-ink-550 font-yl-mono"
        >
